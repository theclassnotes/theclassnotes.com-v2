...
<tr>
<td align="right">
<B>Name</B>:</td><td width=60%><input type="text" name="Name" value="<? echo $row["Name"] ?>" maxlength=30 size=30>
</td>
</tr>
<tr>
<td align="right">
<B>Artist</B>:</td><td width=60%><input type="text" name="Artist" value="<? echo $row["Artist"] ?>" maxlength=30 size=30>
</td>
</tr>
<tr>
<td  align="right">
<B>Arranger</B> (lastname, firstname):</td><td width=60%><input type="text" name="Arranger" value="<? echo $row["Arranger"] ?>" maxlength=30 size=30>
</td>
</tr>
<tr>
<td align="right">
...
<tr>
  <td align="right">
  <input type="submit" value="Submit" name="submit"><td width=60%>Script written by Gei-Tai Lin</td></tr>
</form></table>
<?
if ($submit)
{
